...
def main() -> None:
    ...
    # --- Load data ---
    input_path = Path("data/processed/selected_movies_with_ai_2models.csv")
    ...
    base_cols = [
        ...
        "gpt4_rating",    # small OpenAI model (from add_ai_rating_small.py)
        "claude3_rating", # small Anthropic model (from add_ai_rating_small.py)
